...
object SeedCatalog {
    ...
    val rules: List<CategoryRule> = buildRules(
        ...
        "cat-restaurants" to listOf("RESTAURANT", "CAFE", "MCDONALD", "BURGER KING", "LIEFERANDO", "IMBISS", "LANGOS", "BACKEREI", "BAECKEREI", "STARBUCKS", "DELIVEROO", "WOLT", "PIZZERIA", "SUSHI", "DOENER", "KFC", "SUBWAY", "VAPIANO", "L'OSTERIA", "LOSTERIA", "NORDSEE", "BISTRO", "KANTINE", "GASTSTAETTE", "EISCAFE", "EISDIELE"),
        ...
        "cat-salary" to listOf("LOHN", "GEHALT", "LOHN/GEHALT", "LOHN GEHALT", "BEZUEGE", "LOHNABRECHNUNG", "GEHALTSABRECHNUNG"),
        "cat-income" to listOf("RENTE", "KINDERGELD", "STEUERERSTATTUNG", "DIVIDENDE", "HONORAR", "ELTERNGELD", "BAFOEG", "ZINSGUTSCHRIFT"),
        ...
        "cat-transfers" to listOf("UMBUCHUNG", "SPAREN", "SPARPLAN", "DAUERAUFTRAG SPAREN", "RUECKLAGE", "TAGESGELD", "FESTGELD", "DEPOTUEBERTRAG", "UEBERTRAG", "EIGENUEBERTRAG", "EIGENE UEBERWEISUNG", "KREDITKARTENABRECHNUNG", "KREDITKARTEN", "VISA ABRECHNUNG", "MASTERCARD ABRECHNUNG", "ERSTATTUNG", "RUECKERSTATTUNG", "RUECKZAHLUNG", "RETOURE", "STORNO"),
    )
